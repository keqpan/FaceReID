...
#     faceid = load_model(faceid, faceid_ckpt_path, multigpu_mode)
    ...
    models_dict = {
                    'mmnet': {
                        'model': mmnet,
                         'load_ckpt': "/home/safin/ms-thesis/ckpt/16.04_resdnet_5it/denoiser/weights_100"
                    },
                    'faceid': {
                         'model': faceid,
                         'load_ckpt': "/home/safin/FaceReID/ckpt/mobile_16.04/faceid/weights_30"
                    },
                    'argcmargin': {
                         'model': arcmargin,
                         'load_ckpt': "/home/safin/FaceReID/ckpt/mobile_16.04/arcmargin/weights_30"
                    }
                  }
